...
async function generatePage(name: string, options: GenerateOptions, config: { features?: { typescript?: boolean } }) {
...
async function generateService(name: string, options: GenerateOptions, config: { features?: { typescript?: boolean } }) {
...
async function generateLayout(name: string, options: GenerateOptions, config: { features?: { typescript?: boolean } }) {
...
async function generateMiddleware(name: string, options: GenerateOptions, config: { features?: { typescript?: boolean } }) {
